...
| **Vercel**        | 仅静态 Web + 无状态 `POST /integrations/chat`；**无**持久化、后台任务与主动推送；试点/生产请用 VPS systemd（`deploy/vps/README.zh.md`） |
...
- `deploy/vps/README.zh.md` — VPS 本机 systemd 一体机部署（试点与生产推荐）
