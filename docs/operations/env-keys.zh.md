...
> **仅本地一键栈**，用于本地一次性起完整（Mosquitto + Redis + API + Web + 模拟器）。VPS 部署已全切 systemd，**不在**此处描述，详见 [`deploy/vps/README.zh.md`](../../deploy/vps/README.zh.md) 与 [`deploy/vps/TROUBLESHOOTING.zh.md`](../../deploy/vps/TROUBLESHOOTING.zh.md) `§3 API 启动`。
