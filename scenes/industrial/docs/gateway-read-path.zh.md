...
| ---------------- | -------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| Modbus TCP / RTU | [`modbus-serial`](https://www.npmjs.com/package/modbus-serial) | **推荐评估**；持 holding/coil/input 读写能力，本阶段以**读 + 转 telemetry**为主 |
| OPC UA           | [`node-opcua`](https://www.npmjs.com/package/node-opcua)       | **推荐评估**；优先 browse / subscribe / read                                    |
