...
import { buildWechatRow, isPromotableToWechat, utteranceInMatrix } from "./promote-wechat-lib.js";
...
describe("promote-wechat-lib", () => {
  ...
  it("rejects low confidence and promoted rows", () => {
  ...
  it("utteranceInMatrix tracks in-run list", () => {
    const wechat = [{ utterance: "2号棚B区浇水8分钟", expected_skill: "irrigation.start" }];
